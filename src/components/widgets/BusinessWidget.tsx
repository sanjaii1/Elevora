        ...
        >
            ...
            <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-xs font-medium text-slate-400 dark:text-slate-500 uppercase tracking-wider">Business</span>
                </div>

                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-1">Freelance</h3>
                <p className="text-2xl font-bold text-slate-900 dark:text-white mb-4">
                    $8,450 <span className="text-sm font-normal text-slate-500 dark:text-slate-400">this month</span>
                </p>
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-700/50 rounded-xl border border-slate-100 dark:border-slate-700">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-medium text-slate-700 dark:text-slate-200">Active Clients</span>
                        </div>
                        <span className="text-xs font-bold bg-indigo-100 dark:bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 px-2 py-1 rounded-full">
                            3 Active
                        </span>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-700/50 rounded-xl border border-slate-100 dark:border-slate-700">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-medium text-slate-700 dark:text-slate-200">Pending Invoices</span>
                        </div>
