        ...
        >
            ...
            <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">Social</span>
                </div>

                <h3 className="text-lg font-semibold text-slate-900 mb-1">Connections</h3>
                <p className="text-sm text-slate-500 mb-4">2 birthdays this week 🎂</p>
                ...
                <div className="space-y-3">
                    <div className="flex items-center gap-3">
                        ...
                        <button className="p-2 hover:bg-slate-100 rounded-full text-slate-400 hover:text-blue-500 transition-colors">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-slate-500">Catch up overdue</p>
                        </div>
                        <button className="p-2 hover:bg-slate-100 rounded-full text-slate-400 hover:text-blue-500 transition-colors">
                            <MessageCircle className="w-4 h-4" />
                        </button>
