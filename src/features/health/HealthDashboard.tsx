    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-slate-900">Health Records</h1>
                    <p className="text-sm md:text-base text-slate-500">Manage your medical information and health data.</p>
                </div>
