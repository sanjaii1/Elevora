        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 h-full">
            ...
            <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                    <h4 className="text-sm font-bold text-slate-700">Weekly Activity</h4>
                    <span className="text-xs text-slate-500">285 mins total</span>
                </div>
                ...
                <div className="flex items-end justify-between h-32 gap-2">
                    {activity.map((mins, i) => (
                        <div key={i} className="flex-1 flex flex-col items-center gap-2 group">
                            ...
                            <span className="text-xs font-medium text-slate-400">{weekDays[i]}</span>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div>
                <h4 className="text-sm font-bold text-slate-700 mb-4">Today's Meals</h4>
                        ...
                        <div key={i} className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-100">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500">{item.meal}</p>
                                </div>
                            </div>
