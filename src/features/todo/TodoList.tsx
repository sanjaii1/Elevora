                    ...
                    >
                        ...
                        >
                            {todo.completed ? (
                                ...
                                <Circle className="w-6 h-6 text-slate-300 dark:text-slate-500 hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors" />
                            )}
                        </button>

                        <div className="flex-1 min-w-0">
                            <p className={`font-medium ${todo.completed ? "text-slate-400 dark:text-slate-500 line-through" : "text-slate-900 dark:text-white"}`}>
                                {todo.text}
                            </p>
                            <div className="flex items-center gap-2 mt-1">
                                <span className="text-xs bg-white dark:bg-slate-800 px-2 py-0.5 rounded-full text-slate-600 dark:text-slate-400">
                                    {todo.category}
                                </span>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="p-2 text-slate-400 dark:text-slate-500 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/20 rounded-lg transition-all opacity-0 group-hover:opacity-100"
                        >
